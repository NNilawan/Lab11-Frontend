  ...
  <div>
    ...
    <form  @submit.prevent="saveOrganizer">
     ...
     <h3>The image of the Organizer</h3>
      <UploadImages @changed="handleImages" :max="1" maxError="Max files exceed"/>
...
export default {
  ...
  methods: {
    saveOrganizer() {
      ...
      this.organizer.imageUrls = this.organizer.imageUrls[0]
      OrganizerService.saveOrganizer(this.organizer)
        .then((response) => {
          ...
          this.GStore.flashMessage = 'You are successfully add a new organizer for ' + response.data.name
          setTimeout(() => {
